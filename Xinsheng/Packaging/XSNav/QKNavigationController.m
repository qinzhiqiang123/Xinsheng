...
//    [[UINavigationBar appearance] setBackgroundColor:[UIColor colorWithRed:1.0/255.0 green:255.0/255.0 blue:255.0/255.0 alpha:1]];
    [[UINavigationBar appearance] setBarTintColor:[UIColor whiteColor]];
    [[UINavigationBar appearance] setBackgroundColor:[UIColor whiteColor]];
//    [[UINavigationBar appearance] setShadowImage:[UIImage imageNamed:[UIColor colrw\]]];
    //修改标题字体颜色及大小
...
- (void)pushViewController:(UIViewController *)viewController animated:(BOOL)animated
{
    if (self.childViewControllers.count > 0) {
        ...
        [backButton setImage:[UIImage imageNamed:@"backArrow_left_black"] forState:UIControlStateNormal];
        [backButton setImage:[UIImage imageNamed:@"backArrow_left_black"] forState:UIControlStateHighlighted];
...
//        viewController.navigationItem.leftBarButtonItem.width=25;
